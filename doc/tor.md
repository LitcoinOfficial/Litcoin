...
config file):
	...
	HiddenServicePort 18433 127.0.0.1:18433

The directory can be different of course, but (both) port numbers should be equal to
your zcashd's P2P listen port (8433 by default).
...
and open port 8433 on your firewall (or use -upnp).
...
Now use zcash-cli to verify there is only a single peer connection.
	...
	[
	    {
	        "id" : 1,
	        "addr" : "zctestseie6wxgio.onion:18433",
	        ...
	        "version" : 170002,
